...
function CheckLevel() 
    ...
    elseif World3 then
        ...
        elseif MyLevel >= 2425 or _G.SelectMonster == "Snow Demon [Lv. 2425]" then
            ...
            SPAWNPOINT = "Chocolate"   
        elseif MyLevel >= 2450 or _G.SelectMonster == "Isle Outlaw [Lv. 2450]" then
            ...
            SPAWNPOINT = "Isle Outlaw"    
        elseif MyLevel >= 2475 or _G.SelectMonster == "Island Boy [Lv. 2475]" then
            ...
            SPAWNPOINT = "Island Boy"
        elseif MyLevel >= 2525 or _G.SelectMonster == "Isle Outlaw [Lv. 2450]" then
...
local Swords = Library:Tab("Auto Item","rbxassetid://9606626034")
...
Main:Label("Join Invite Discord : Speed Hub X")
...
Main:Toggle("Auto Farm On Select Mode",_G.Auto_Farm_Level,function(value)
...
game.StarterGui:SetCore("SendNotification", {
    ...
    Text = "Mirage has not Spawn"; -- what the text says (ofc)
